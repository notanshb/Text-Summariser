...
AUTHOR_USER_NAME = "notanshb"
SRC_REPO = "textSummariser" #folder inside src
AUTHOR_EMAIL = "bhardwajansh@outlook.com"
...
setuptools.setup(
    ...
    description="A small pythonn package for NLP app",
